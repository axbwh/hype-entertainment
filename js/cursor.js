...
const initCursor = () => {
  if (!isMobile) {
    ...
    let clientX = 0, clientY = 0, lastX = 0, lastY = 0
    ...
    let cursorTriggers = document.querySelectorAll('a, .he-nav-link, .he-project-title,  .he-cross, .simplebar-track, .he-subnav-spacer-wrap')
